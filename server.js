...
app.post('/api/contacts', (req, res) => {  
  const { alias, firstName, lastName, phone } = req.body
  return db.Contact.create({ alias, firstName, lastName, phone })
...
app.put('/api/contacts/:id', (req, res) => {  
  ...
  .then((contact) => {
    const { alias, firstName, lastName, phone } = req.body
    return contact.update({ alias, firstName, lastName, phone })
